...
function attack3() {
	...
	// был таймер
	if(timer && maxcard.multi != 1.5) return $("a.btn.blue:text(обновить)").cl({timer1: 4000, log: 'Есть карты с таймером и нет с множителем 1.5 - ждём 4 секунды и обновляемся'});
